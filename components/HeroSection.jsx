...
const HeroSection = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a1f44] to-[#03142b] text-white flex items-center px-8 md:px-20 relative overflow-hidden">
      {/* Stars background */}
      ...
      <div className="z-10 grid grid-cols-1 md:grid-cols-2 items-center gap-10 w-full">
        ...
        >
          <div className="w-[340px] h-[240px] md:w-[420px] md:h-[280px] bg-gradient-to-br from-blue-800 to-indigo-900 rounded-3xl p-6 shadow-2xl border border-blue-500/20">
            <div className="w-full h-full bg-transparent rounded-xl border border-blue-300/30 grid grid-rows-3 grid-cols-6 items-end p-2">
              <motion.svg
